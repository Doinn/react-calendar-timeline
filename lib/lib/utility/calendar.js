...
function groupStack(lineHeight, item, group, groupHeight, groupTop, itemIndex) {
  ...
  var verticalMargin = Math.min(Math.abs(lineHeight - item.dimensions.height) / 2, 8);
  var computedLineHeight = item.dimensions.height > lineHeight ? 2 * verticalMargin + item.dimensions.height : lineHeight;
