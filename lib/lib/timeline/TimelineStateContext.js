  ...
  _createClass(TimelineStateProvider, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          visibleRowFirst = _this$props4.visibleRowFirst,
          visibleRowLast = _this$props4.visibleRowLast,
          groupTopsPrefixSum = _this$props4.groupTopsPrefixSum;

      if (!this._cachedValue || this._lastFirst !== visibleRowFirst || this._lastLast !== visibleRowLast || this._lastPrefix !== groupTopsPrefixSum) {
        this._lastFirst = visibleRowFirst;
        this._lastLast = visibleRowLast;
        this._lastPrefix = groupTopsPrefixSum;
        this._cachedValue = _objectSpread({}, this.state.timelineContext, {
