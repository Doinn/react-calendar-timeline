...
var passThroughPropTypes = {
  ...
  horizontalLineClassNamesForGroupCell: _propTypes["default"].func,
  onRowContextClick: _propTypes["default"].func.isRequired,
  canvasTimeStart: _propTypes["default"].number,
  canvasTimeEnd: _propTypes["default"].number,
  minUnit: _propTypes["default"].string,
  timeSteps: _propTypes["default"].object,
  groupIdCells: _propTypes["default"].array
};
...
function (_Component) {
  ...
  _createClass(GroupRows, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.canvasWidth === this.props.canvasWidth && nextProps.lineCount === this.props.lineCount && nextProps.groupHeights === this.props.groupHeights && nextProps.groups === this.props.groups && nextProps.canvasTimeStart === this.props.canvasTimeStart && nextProps.canvasTimeEnd === this.props.canvasTimeEnd && nextProps.minUnit === this.props.minUnit && nextProps.timeSteps === this.props.timeSteps && nextProps.groupIdCells === this.props.groupIdCells && nextProps.visibleRowFirst === this.props.visibleRowFirst && nextProps.visibleRowLast === this.props.visibleRowLast);
    }
  }, {
    key: "render",
    value: function render() {
      var _this$props = this.props,
          ...
          horizontalLineClassNamesForGroupCell = _this$props.horizontalLineClassNamesForGroupCell,
          ...
          groupIdCells = _this$props.groupIdCells,
      ...
      var last = useVirtualization ? Math.min(visibleRowLast, lineCount - 1) : lineCount - 1;
      var topSpacerHeight = useVirtualization ? groupTopsPrefixSum[first] || 0 : 0;
      var totalHeight = useVirtualization ? groupTopsPrefixSum[lineCount] || 0 : 0;
      var bottomSpacerHeight = useVirtualization ? Math.max(0, totalHeight - (groupTopsPrefixSum[last + 1] || 0)) : 0;
      var lines = [];
      ...
      if (topSpacerHeight > 0) {
        lines.push(_react["default"].createElement("div", {
          ...
          style: {
            height: "".concat(topSpacerHeight, "px"),
      ...
      if (bottomSpacerHeight > 0) {
        lines.push(_react["default"].createElement("div", {
          ...
          style: {
            height: "".concat(bottomSpacerHeight, "px"),
            width: "".concat(canvasWidth, "px")
          }
        }));
      }
...
_defineProperty(GroupRows, "propTypes", _objectSpread({}, passThroughPropTypes, {
...
var GroupRowsWrapper = function GroupRowsWrapper(_ref) {
  ...
  return _react["default"].createElement(_TimelineStateContext.TimelineStateConsumer, null, function (_ref2) {
    var getLeftOffsetFromDate = _ref2.getLeftOffsetFromDate,
        visibleRowFirst = _ref2.visibleRowFirst,
        visibleRowLast = _ref2.visibleRowLast,
        groupTopsPrefixSum = _ref2.groupTopsPrefixSum;
    return _react["default"].createElement(GroupRows, _extends({
      getLeftOffsetFromDate: getLeftOffsetFromDate,
